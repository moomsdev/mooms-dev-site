...
class OptimizeImages
{
    ...
    public function __construct()
    {
        ...
        // WP-CLI command: wp mms optimize-images --min_kb=500 --limit=200
     ...
     */
    public static function bulk_optimize($minSizeKB = 500, $limit = 50, $offset = 0)
    {
        $args = [
    ...
    public static function ajax_bulk_optimize_images()
    {
        ...
        $minKB = isset($_POST['min_kb']) ? max(1, (int) $_POST['min_kb']) : 500;
    ...
    /**
     * WP-CLI: wp mms optimize-images --min_kb=500 --limit=200
     */
    public static function cli_optimize_images($args, $assoc_args)
    {
        $minKB = isset($assoc_args['min_kb']) ? (int) $assoc_args['min_kb'] : 500;
