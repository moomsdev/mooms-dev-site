...
Block::make(__('Block ABOUT ME', 'mms'))
    ->add_fields([
        Field::make('separator', 'about_spt', __('BLOCK ABOUT ME', 'mms')),
        //Circle
        Field::make('text', 'welcome_content', __('', 'mms'))
            ->set_attribute('placeholder', 'Nhập nội dung circle')
            ->set_default_value('about me - about me - about me - about me - about me -'),
        //Image
        Field::make('image', 'about_image', __('', 'mms')),
        //Title
        Field::make('text', 'about_title', __('', 'mms'))
            ->set_attribute('placeholder', 'Nhập tiêu đề của block'),
        //Description
        Field::make('textarea', 'about_desc', __('', 'mms'))
