...
Block::make(__('Block blog', 'mms'))
    ->add_fields([
        Field::make('separator', 'blog_spt', __('BLOCK TIN TỨC', 'mms')),
        //Title
        Field::make('text', 'blog_title', __('', 'mms'))->set_width(60)
            ->set_attribute('placeholder', 'Nhập tiêu đề của block'),
        //Description
        Field::make('textarea', 'blog_desc', __('', 'mms'))
            ->set_attribute('placeholder', 'Nhập mô tả của block'),
        //URL
        Field::make('text', 'blog_page_url', __('', 'mms'))->set_width(30)
            ->set_attribute('placeholder', 'Nhập URL của trang blog'),
        // type media
        Field::make('select', 'display_type', __('', 'mms'))->set_width(20)
        ...
        //Auto
        Field::make('separator', 'auto_spt', __('Tự động hiển thị 3 bài viết mới nhất', 'mms'))->set_width(50)
            ->set_conditional_logic([
                'relation' => 'AND',
                ['field' => 'display_type', 'value' => 'auto', 'compare' => '='],
            ]),
        //Manual
        Field::make('separator', 'manual_spt', __('Chọn bài viết thủ công', 'mms'))->set_width(50)
            ->set_conditional_logic([
                'relation' => 'AND',
                ['field' => 'display_type', 'value' => 'manual', 'compare' => '='],
            ]),
        //Manual
        Field::make('association', 'manual_blog', __('', 'mms'))->set_width(70)
            ->set_types([
                [
                    'type'      => 'post',
                    'post_type' => 'blog',
