<?php
/*
Plugin Name: Language Weaver
Plugin URI: https://festingervault.com/p/language-weaver/
Version: 2.7.2
Description: Translate your website directly from your admin panel with Language Weaver! Say goodbye to manual file editing and hello to effortless translation.
...
Language Weaver available through Festinger Vault is an independent version maintained by our team. We are not affiliated, endorsed, or associated with Loco Translate or Tim Whitlock in any way. Our support is exclusively for the forked version available in Festinger Vault. If you require official updates, premium features, or priority support from the original developers, we strongly recommend purchasing a valid license from them.
*/
