...
<div id="play7" class="ft-card-mail toggle-div">
	...
	<h3><i class="fa-regular fa-paper-plane-top"></i> <?php _e('Send test email', 'foxtool') ?></h3>
	<div style="display:flex;">
	<input class="ft-input-big" id="ft-mailtest" placeholder="<?php _e('Enter email', 'foxtool'); ?>" type="text" value=""/>
	<a id="ft-send-email" href="javascript:void(0)" data-nonce="<?php echo wp_create_nonce('ft-send-email-nonce'); ?>"><?php _e('Send', 'foxtool'); ?></a>
	</div>
	<div id="ft-sen-end"></div>
	<div class="edoi" style="display:none"><div class="ft-sload"></div>  <?php _e('Please wait for the email to be sent', 'foxtool'); ?></div>
	<script>
	// cấu hình email
