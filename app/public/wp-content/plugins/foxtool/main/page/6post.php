...
<div id="play6" class="ft-card toggle-div">
  <h3><i class="fa-regular fa-image"></i> <?php _e('Image function for posts', 'foxtool') ?></h3>
	...
	<!-- post up hinh anh 1 -->
	<label class="nut-switch">
	<input type="checkbox" name="foxtool_settings[post-up11]" value="1" <?php if ( isset($foxtool_options['post-up11']) && 1 == $foxtool_options['post-up11'] ) echo 'checked="checked"'; ?> />
	<span class="slider"></span></label>
	<label class="ft-label-right"><?php _e('Remove img tag attributes', 'foxtool'); ?></label>
	</p>
	...
	<input id="ft-add5" class="ft-input-big" name="foxtool_settings[post-thum11]" type="text" value="<?php if(!empty($foxtool_options['post-thum11'])){echo sanitize_text_field($foxtool_options['post-thum11']);} ?>" placeholder="<?php _e('Add default featured image', 'foxtool'); ?>" />
  ...
  <h3><i class="fa-regular fa-hammer"></i> <?php _e('Additional feature', 'foxtool') ?></h3>
	...
	<span class="slider"></span></label>
	<label class="ft-label-right"><?php _e('Allow using Shortcode in post titles', 'foxtool'); ?></label>
	<p class="ft-note"><i class="fa-regular fa-lightbulb-on"></i> <?php _e('This feature allows you to add Shortcode to post titles, which is very convenient for using custom tools', 'foxtool'); ?></p>
	<!-- other 2 -->
	<label class="nut-switch">
  ...
  <h3><i class="fa-regular fa-calendar-image"></i> <?php _e('Advanced image viewing feature in posts', 'foxtool') ?></h3>
	...
	<span class="slider"></span></label>
	<label class="ft-label-right"><?php _e('Show full image', 'foxtool'); ?></label>
	</p>
