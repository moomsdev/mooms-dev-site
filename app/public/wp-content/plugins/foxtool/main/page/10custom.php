...
<div id="play10" class="ft-card toggle-div">
  <h3><i class="fa-regular fa-screwdriver-wrench"></i> <?php _e('Change login link', 'foxtool') ?></h3>
	...
	<p>
	<input class="ft-input-big" name="foxtool_settings[custom-chan11]" type="text" value="<?php if(!empty($foxtool_options['custom-chan11'])){echo sanitize_text_field($foxtool_options['custom-chan11']);} ?>" placeholder="<?php _e('Enter a suffix', 'foxtool'); ?>" />
	</p>
  ...
  <h3><i class="fa-regular fa-swatchbook"></i> <?php _e('Custom WordPress login page', 'foxtool') ?></h3>
	...
	<input id="ft-add2" class="ft-input-big" name="foxtool_settings[custom-logo1]" type="text" value="<?php if(!empty($foxtool_options['custom-logo1'])){echo sanitize_text_field($foxtool_options['custom-logo1']);} ?>" placeholder="<?php _e('Add the image logo link here', 'foxtool'); ?>" />
	...
	<p style="display:flex;">
	<input id="ft-add3" class="ft-input-big" name="foxtool_settings[custom-bg12]" type="text" value="<?php if(!empty($foxtool_options['custom-bg12'])){echo sanitize_text_field($foxtool_options['custom-bg12']);} ?>" placeholder="<?php _e('Add background image link', 'foxtool'); ?>" />
  ...
  <h3><i class="fa-brands fa-wordpress"></i> <?php _e('Change WordPress logo in the Admin bar', 'foxtool') ?></h3>
	...
	<p style="display:flex;">
	<input id="ft-add4" class="ft-input-big" name="foxtool_settings[custom-logbar21]" type="text" value="<?php if(!empty($foxtool_options['custom-logbar21'])){echo sanitize_text_field($foxtool_options['custom-logbar21']);} ?>" placeholder="<?php _e('Add logo link', 'foxtool'); ?>" />
